...
// Тесты для функции -- int s21_sum_matrix(matrix_t *A, matrix_t *B, matrix_t
// *result);
...
// Тесты для функции -- int s21_sub_matrix(matrix_t *A, matrix_t *B, matrix_t
// *result);
...
// Тесты для функции -- int s21_mult_number(matrix_t *A, double number, matrix_t
// *result);
...
// Тесты для функции -- int s21_mult_matrix(matrix_t *A, matrix_t *B, matrix_t
// *result);
...
// Тесты для функции -- int s21_transpose(matrix_t *A, matrix_t *result);
...
// Тесты для функции -- int s21_determinant(matrix_t *A, double *result);
...
// Тесты для функции -- int s21_calc_complements(matrix_t *A, matrix_t *result);
...
// Тесты для функции -- int s21_inverse_matrix(matrix_t *A, matrix_t *result);
...
// Набор тестов для функции -- int s21_create_matrix(int rows, int columns,
// matrix_t *result);
...
// Набор тестов для функции -- void s21_remove_matrix(matrix_t *A);
...
// Набор тестов для функции -- int s21_eq_matrix(matrix_t *A, matrix_t *B);
...
// Набор тестов для функции -- int s21_sum_matrix(matrix_t *A, matrix_t *B,
// matrix_t *result);
...
// Набор тестов для функции -- int s21_sub_matrix(matrix_t *A, matrix_t *B,
// matrix_t *result);
...
// Набор тестов для функции -- int s21_mult_number(matrix_t *A, double number,
// matrix_t *result);
...
// Набор тестов для функции -- int s21_mult_matrix(matrix_t *A, matrix_t *B,
// matrix_t *result);
...
// Набор тестов для функции -- int s21_transpose(matrix_t *A, matrix_t *result);
...
// Набор тестов для функции -- int s21_determinant(matrix_t *A, double *result);
...
// Набор тестов для функции -- int s21_calc_complements(matrix_t *A, matrix_t
// *result);
...
// Набор тестов для функции -- int s21_inverse_matrix(matrix_t *A, matrix_t
// *result);
